...
const Profile = () => {
    ...
    const [isActiveButton, setActiveButton] = useState(location.pathname.includes('favorite'));
            ...
            <div className="m-card d-flex">
                ...
                <div className="col-6">
                    <div className="d-flex mb-3">
                        ...
                        <span className="ml-1 mr-1 text-muted">Ngày tham gia:</span>
                    ...
                    <div className="d-flex">
                        ...
                        <span className="ml-1 mr-1 text-muted">Số điện thoại:</span>
                        <span>{currentUser.phone_number}</span>
                    </div>
                </div>
            </div>
            <div className="container mt-3">
                <button className={"btn mr-2 " + (isActiveButton ? "btn-outline-primary" : "btn-primary")}
                    onClick={() => switchListPost('/profile', true)}>
                    Bài đăng cá nhân
                </button>
                <button className={"btn " + (isActiveButton ? "btn-primary" : "btn-outline-primary")}
